...
public class DisputeRequestController {
    ...
    public ResponseEntity<DisputeRequestResponse> create(
        ...
        DisputeRequestResponse response = disputeRequestService.create(userId, request);
    ...
    public ResponseEntity<List<DisputeRequestResponse>> getRequests(
        ...
        List<DisputeRequestResponse> responses = disputeRequestService.getRequests(userId);
    ...
    public ResponseEntity<DisputeRequestResponse> getRequest(
        ...
        DisputeRequestResponse response = disputeRequestService.getRequest(userId, disputeRequestId);
    ...
    public ResponseEntity<DisputeRequestResponse> approve(@PathVariable Long disputeRequestId) {
        DisputeRequestResponse response = disputeRequestService.approve(disputeRequestId);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<DisputeRequestResponse> reject(
        ...
        DisputeRequestResponse response = disputeRequestService.reject(disputeRequestId, adminResponse);
