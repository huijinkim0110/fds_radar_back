...
public class SuitabilityCheckController {
    ...
    @PostMapping
    public ResponseEntity<SuitabilityChecks> checkSuitability(
            @AuthenticationPrincipal Long userId,
            @RequestBody SuitabilityCheckRequestDTO dto) {
        SuitabilityChecks result = suitabilityCheckService.checkSuitability(userId, dto);
