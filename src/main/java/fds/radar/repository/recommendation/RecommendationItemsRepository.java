...
public interface RecommendationItemsRepository extends JpaRepository<RecommendationItems, Long> {
    ...
    // 본인 소유 추천이력 검증용
    List<RecommendationItems> findByRecommendationResult_RecommendationResultIdAndRecommendationResult_User_UserIdOrderByRankingAsc(Long recommendationResultId, Long userId);
}
